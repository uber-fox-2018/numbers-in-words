function number_word(number) {
    ...
    if(number >= 100 && number < 200){
      let index = Math.floor(number-100);
    ...
    if(number >= 1000 && number < 2000){
      let index = Math.floor(number-1000);
